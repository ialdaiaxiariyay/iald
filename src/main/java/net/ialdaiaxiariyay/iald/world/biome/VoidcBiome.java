...
package net.ialdaiaxiariyay.iald.world.biome;
...
public class VoidcBiome extends IaldModElements.ModElement {
	public static Biome biome;

	public VoidcBiome(IaldModElements instance) {
		super(instance, 4);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(10f).scale(2f).temperature(2f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("iald:voidc"));
			}
		}
	}
